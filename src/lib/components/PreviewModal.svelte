<script lang="ts">
  ...
  const modalClass =
    "center justify-between z-30 w-full h-full md:h-fit md:max-w-4xl fixed gap-y-3 md:gap-y-20 px-10 py-5 bg-gray-900 md:border md:border-slate-600 rounded drop-shadow-xl";
